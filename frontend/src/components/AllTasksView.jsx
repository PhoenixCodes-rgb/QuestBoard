    ...
    <div className="mt-8 space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <motion.button
          ...
          className="flex items-center gap-2 self-start rounded-full bg-[#193b27] px-5 py-3 text-sm font-medium text-white shadow-sm transition hover:bg-green-800 sm:self-auto"
        >
          <FiPlus />
          <span>Add task</span>
        </motion.button>
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
        <div className="rounded-3xl bg-white p-5 shadow-sm">
          ...
          <p className="mt-1 text-xs text-gray-500">Across all scheduled dates</p>
        </div>
        ...
        <div className="rounded-3xl bg-white p-5 shadow-sm">
          ...
          <h3 className="mt-2 text-3xl font-semibold text-amber-600">
            {pendingCount}
          </h3>
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="rounded-xl border border-gray-200 bg-gray-50 px-3 py-1.5 text-xs font-medium text-gray-700 outline-none transition focus:border-green-600"
            >
      ...
      {filteredTasks.length === 0 ? (
        ...
        >
          ...
          <h3 className="mt-5 text-lg font-semibold">No tasks found</h3>
